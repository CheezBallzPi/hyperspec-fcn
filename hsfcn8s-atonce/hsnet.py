...
def fcn(split):
    ...
    # fully conv
    n.fc7, n.relu7 = conv_relu(n.relu2, 4096, ks=1, pad=0)
    n.drop7 = L.Dropout(n.relu7, dropout_ratio=0.5, in_place=True)

    n.score_fr = L.Convolution(n.drop7, num_output=9, kernel_size=1, pad=0,
                               param=[dict(lr_mlt=1, decay_mult=1), dict(lr_mult=2, decay_mult=0)])
    
    n.upscore = L.Deconvolution(n.score_fr,
        convolution_param=dict(num_output=9, kernel_size=27, stride=32,
            bias_term=False),
